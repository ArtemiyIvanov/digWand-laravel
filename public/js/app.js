...
var cartImage = 'https://via.placeholder.com/100x80'; //Глобальные сущности
...
function renderProducts() {
  ...
  if (!search) {
    ...
    var _arr = [];
    items.forEach(function (item) {
      var prod = createProduct(item);

      _arr.push(prod.createTemplate());
    });
    document.querySelector('.products').innerHTML = _arr.join();
  }
...
function renderCart() {
  ...
  var _iterator2 = _createForOfIteratorHelper(userCart),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      item = _step2.value;
      allProducts += "<div class=\"cart-item\" data-id=\"".concat(item.id, "\">\n                            <div class=\"product-bio\">\n                                <img src=\"").concat(item.img, "\" alt=\"Some image\">\n                                <div class=\"product-desc\">\n                                    <p class=\"product-title\">").concat(item.name, "</p>\n                                    <p class=\"product-quantity\">Quantity: ").concat(item.quantity, "</p>\n                                    <p class=\"product-single-price\">$").concat(item.price, " each</p>\n                                </div>\n                            </div>\n                            <div class=\"right-block\">\n                                <p class=\"product-price\">").concat(item.quantity * item.price, "</p>\n                                <button class=\"del-btn\" data-id=\"").concat(item.id, "\">&times;</button>\n                            </div>\n                        </div>");
    }
  } catch (err) {
    _iterator2.e(err);
  } finally {
